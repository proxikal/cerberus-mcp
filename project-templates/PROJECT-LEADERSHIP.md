...
**Core Reference:** See {{PROJECT_NAME}}.md Agent Leadership Protocol section for quick reference
...
**Core Reference:** {{PROJECT_NAME}}.md Agent Leadership Protocol section
